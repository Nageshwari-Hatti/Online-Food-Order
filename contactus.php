...
<html>
  ...
  <head>
    <title> Contact | Food Order System </title>
  </head>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact our <span class="edit"> Food Order System</span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile Number" maxlength="10" required>
          </div>
