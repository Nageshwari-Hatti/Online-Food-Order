<html>
  ...
  <head>
    <title> Manager Signup | Food Order System </title>
  </head>
  ...
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Manager, <br> Welcome to <span class="edit"> Food Order System</span></h1>
     <br>
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="contact" type="text" name="contact" placeholder="Mobile Number" maxlength="10"  required="">
              <span class="input-group-btn">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="password" type="password" name="password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required="">
              <span class="input-group-btn">
